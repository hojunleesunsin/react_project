...
export function ClientUiShell({ children }: { children: React.ReactNode }) {
  ...
  // Tailwind dark variant가 확실히 동작하도록 html 루트에 dark 클래스를 토글
  useEffect(() => {
  ...
  return (
    <div
      className={`min-h-screen ${fontClass} bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100`}
    >
